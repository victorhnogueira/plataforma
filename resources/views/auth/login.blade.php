...
@section('content')
    <style>
        ...
        .bg-image {
            ...
            background-image: url('https://i.imgur.com/MKmzYLF.png');
    ...
    <div id="aaa" class="container-fluid">
                            ...
                            <div class="col-md-9 col-lg-8 mx-auto">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-label-group">
                                        <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="nome@conselt.com.br" autofocus required autocomplete="current-password">
                                        @error('email')
